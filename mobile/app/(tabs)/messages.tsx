import { View, Text, Alert, TouchableOpacity, TextInput, ScrollView, Modal } from 'react-native'
...
const MessagesScreen = () => {
  ...
  const [conversationsList, setConversationsList] = useState(CONVERSATIONS); // state to store the list of conversations
  const [selectedConversation, setSelectedConversation] = useState<ConversationType | null>(null); // state to store the selected conversation
...
const deleteConversation = (conversationId: number) => { // function to delete a conversation
  ...
  const openConversation = (conversation: ConversationType) => { // function to open a conversation
    setSelectedConversation(conversation); 
    setIsChatOpen(true);
  };

    const closeChatModal = () => { // function to close the chat modal
    setIsChatOpen(false);
        ...
        {selectedConversation && (
          <SafeAreaView className="flex-1">
            ...
            <View className="flex-row items-center px-3 py-2 border-t border-gray-100">
              <View className="flex-1 flex-row items-center bg-gray-100 rounded-full px-2 py-1 mr-3">
                <TextInput
